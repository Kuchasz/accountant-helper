  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200 flex items-center justify-between">
        ...
        <Button className="p-1.5 hover:bg-gray-100 rounded-lg border-0 bg-transparent cursor-pointer">
      ...
      <ScrollArea.Root className="flex-1 overflow-hidden">
          ...
          <div className="px-3 mt-6">
            ...
            <div className="space-y-1">
              {accountItems.map((item) => (
                <RouterLink key={item.path} to={item.path} className="block">
                  <Button className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors border-0 bg-transparent cursor-pointer">
                    <div className="flex items-center space-x-3">
                      <item.icon size={20} />
                      <span>{item.label}</span>
                    </div>
        ...
        <ScrollArea.Scrollbar
          ...
          className="flex w-2 bg-gray-100 rounded-full p-0.5"
        >
          <ScrollArea.Thumb className="flex-1 bg-gray-400 rounded-full hover:bg-gray-500 transition-colors" />
        </ScrollArea.Scrollbar>
      </ScrollArea.Root>
      ...
      <div className="border-t border-gray-200 p-3 space-y-1">
        ...
        <div className="flex items-center space-x-3 px-3 py-2.5">
          ...
          <Button className="text-orange-500 border-0 bg-transparent p-0 cursor-pointer">
            <Export size={20} />
          </Button>
        </div>
      </div>
