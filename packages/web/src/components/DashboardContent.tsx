...
const activeSalesBars = [
  { id: 'active-sales-1', height: 40 },
  { id: 'active-sales-2', height: 60 },
  { id: 'active-sales-3', height: 35 },
  { id: 'active-sales-4', height: 70 },
  { id: 'active-sales-5', height: 45 },
  { id: 'active-sales-6', height: 85 },
  { id: 'active-sales-7', height: 50 },
];

const analyticsBars = [
  { id: 'analytics-jan', height: 30 },
  { id: 'analytics-feb', height: 25 },
  { id: 'analytics-mar', height: 35 },
  { id: 'analytics-apr', height: 28 },
  { id: 'analytics-may', height: 40 },
  { id: 'analytics-jun', height: 75, showMarker: true },
  { id: 'analytics-jul', height: 45 },
  { id: 'analytics-aug', height: 35 },
  { id: 'analytics-sep', height: 30 },
  { id: 'analytics-oct', height: 40 },
  { id: 'analytics-nov', height: 35 },
  { id: 'analytics-dec', height: 38 },
];

export function DashboardContent() {
  const { t } = useTranslation();
  const [selectedYear, setSelectedYear] = useState(t('dashboard.thisYear'));
  const { data: fakeWidgetsSetting } = trpc.getSetting.useQuery({
    key: 'dashboard_show_fake_widgets',
  });
  const showFakeWidgets = fakeWidgetsSetting?.value === 'true';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="flex items-end justify-between h-20">
                {activeSalesBars.map((bar) => (
                  <div key={bar.id} className="flex-1 mx-0.5">
                    <div
              ...
              <div className="relative h-48">
                <div className="absolute inset-0 flex items-end justify-between">
                  {analyticsBars.map((bar) => (
                    <div key={bar.id} className="flex-1 mx-1 relative group">
                      <div
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  <Select.Trigger className="text-sm text-gray-600 border-0 bg-transparent p-0 cursor-pointer flex items-center space-x-1">
                    <Select.Value placeholder={t('dashboard.selectYear')}>
                      {selectedYear}
                    </Select.Value>
